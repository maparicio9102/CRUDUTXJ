...
<script src="{{url('/js/Catalogos/vendedor.js')}}"></script>
                        ...
                        <div class="full-width panel mdl-shadow--2dp">
                            ...
                            <div class="full-width panel-content">
                                <form>
                                    <div class="mdl-grid">
                                        <div class="mdl-cell mdl-cell--12-col">
                                            <legend class="text-condensedLight"><i class="zmdi zmdi-border-color"></i>&nbsp; Datos del Vendedor</legend>
                                            <br>
                                        </div>
                                        ...
                                        <div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                ...
                                                <label class="mdl-textfield__label" for="txt_apPaterno">Apellido Paterno</label>
										...
										<div class="mdl-cell mdl-cell--6-col mdl-cell--8-col-tablet">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                ...
                                                <label class="mdl-textfield__label" for="txt_apMaterno">Apellido Materno</label>
                                                <span class="mdl-textfield__error">Apellido Invalido</span>
                                            </div>
                                        </div>
                                    ...
                                    <p class="text-center">
                                        <button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" onclick="altaVendedor();"  id="btn-addClient">
                                            <i class="zmdi zmdi-plus"></i>
                                        </button>
                                        <div class="mdl-tooltip" for="btn-addClient">Agregar Vendedor</div>
                                    </p>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
                        <div class="full-width panel mdl-shadow--2dp">
                            ...
                            <div class="full-width panel-content">
                                ...
                                <div class="mdl-list" id="div_listaVendedores" >
